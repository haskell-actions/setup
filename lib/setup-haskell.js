...
async function run(inputs) {
    try {
        ...
        (0, installer_1.addGhcupReleaseChannel)('vanilla', os, arch);
        (0, installer_1.addGhcupReleaseChannel)('prereleases', os, arch);
        if (opts.ghcup.releaseChannel) {
            await core.group(`Preparing ghcup environment`, async () => (0, installer_1.addGhcupReleaseChannel)(opts.ghcup.releaseChannel.toString(), os, arch));
        }
